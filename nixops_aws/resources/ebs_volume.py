...
class EBSVolumeState(nixops.resources.ResourceState, ec2_common.EC2CommonState):
    ...
    def create(self, defn, check, allow_reboot, allow_recreate):
        ...
        self.access_key_id = defn.config['accessKeyId'] or nixops_aws.ec2_utils.get_access_key_id()
    ...
    def check(self):
        volume = nixops_aws.ec2_utils.get_volume_by_id(self.connect(self.region), self.volume_id)
        if volume is None:
    ...
    def destroy(self, wipe=False):
        ...
        volume = nixops_aws.ec2_utils.get_volume_by_id(self._conn, self.volume_id, allow_missing=True)
