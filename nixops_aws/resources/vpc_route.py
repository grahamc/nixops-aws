...
class VPCRouteState(nixops.resources.DiffEngineResourceState, EC2CommonState):
    ...
    def create_after(self, resources, defn):
        return {r for r in resources if
                isinstance(r, nixops_aws.resources.vpc_route_table.VPCRouteTableState) or
                isinstance(r, nixops_aws.resources.vpc_internet_gateway.VPCInternetGatewayState) or
                isinstance(r, nixops_aws.resources.vpc_nat_gateway.VPCNatGatewayState)}
