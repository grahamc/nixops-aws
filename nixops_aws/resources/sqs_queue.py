    ...
    def create(self, defn, check, allow_reboot, allow_recreate):
        ...
        if check or self.state != self.UP:
            ...
            if not q or self.state != self.UP:
                ...
                q = nixops_aws.ec2_utils.retry(lambda: self._conn.create_queue(defn.queue_name, defn.visibility_timeout), error_codes = ['AWS.SimpleQueueService.QueueDeletedRecently'])
