...
class ElasticFileSystemMountTargetState(nixops.resources.ResourceState, efs_common.EFSCommonState):
    ...
    def create(self, defn, check, allow_reboot, allow_recreate):
        ...
        access_key_id = defn.config["accessKeyId"] or nixops_aws.ec2_utils.get_access_key_id()
    ...
    def security_groups_to_ids(self, region, access_key_id, subnetId, groups):
        ...
        if sg_names != [ ] and subnetId != "":
            ...
            groups = map(lambda g: nixops_aws.ec2_utils.name_to_security_group(conn, g, vpc_id), groups)
